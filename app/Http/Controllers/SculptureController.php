...
class SculptureController extends Controller
{
    ...
    {
        $sculptures = Sculpture::with('Art_obj')->get();
        return view('ArtObj.Sculpture', compact('sculptures'));
    }
    ...
    {
        return view('ArtObj.CreateSculpture');
    }
    ...
    {
        $sculptures = Sculpture::find($art_obj_Id_no);
	    ...
	    return view('ArtObj.EditSculpture', compact('sculptures','art_objs','permanents','borrowed','donated','art_obj_Id_no')); 
    }
    ...
    public function update(Request $request, $art_obj_Id_no)
    {
        ...
        $sculptures = Sculpture::find($art_obj_Id_no);
        $sculptures->Material = $request->get('Material');
        $sculptures->Height = $request->get('Height'); 
        $sculptures->Weight = $request->get('Weight');
        $sculptures->Style = $request->get('Style'); 
        $sculptures->save();
