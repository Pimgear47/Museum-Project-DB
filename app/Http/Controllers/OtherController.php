...
class OtherController extends Controller
{
    ...
    {
        $others = Other::with('Art_obj')->get();
        return view('ArtObj.Other', compact('others'));
    }
    ...
    {
        return view('ArtObj.CreateOther');
    }
    ...
    {
        $others = Other::find($art_obj_Id_no);
	    ...
	    return view('ArtObj.EditOther', compact('others','art_objs','permanents','borrowed','donated','art_obj_Id_no')); 
    }
    ...
    public function update(Request $request, $art_obj_Id_no)
    {
        ...
        $others = Other::find($art_obj_Id_no);
        $others->Type = $request->get('Type');
        $others->Style = $request->get('Style'); 
        $others->save();
