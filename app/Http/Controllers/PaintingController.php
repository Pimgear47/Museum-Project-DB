...
class PaintingController extends Controller
{
    ...
    {
        return view('ArtObj.CreatePainting');
    }
    ...
    {
        $paintings = Painting::find($art_obj_Id_no);
	    ...
	    return view('ArtObj.EditPainting', compact('paintings','art_objs','permanents','borrowed','donated','art_obj_Id_no')); 
    }
    ...
    public function update(Request $request, $art_obj_Id_no)
    {
        ...
        $paintings = Painting::find($art_obj_Id_no);
        $paintings->Paint_type = $request->get('Paint_type');
        $paintings->Drawn_on = $request->get('Drawn_on'); 
        $paintings->Style = $request->get('Style'); 
        $paintings->save();
