@extends('layout')
@section('title','Create Sculpture')
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-12">
        <br>
            <h3 align="center">Create Sculpture</h3>
            ...
            @endif 
            <br>
            <form method="post" action="{{action('SculptureController@store')}}" enctype="multipart/form-data">  {{csrf_field()}} 
                ...
                <div class="form-group">
                    <label> Material: </label><input type="text" name="Material" class="form-control" placeholder="Material"/> 
                </div>
                <div class="form-group">
