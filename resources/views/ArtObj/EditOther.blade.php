...
<div class="container">
    <div class="row">
        ...
        <br>
            ...
            @endif 
            <br>
            <form method="post" action="{{action('OtherController@update', $art_obj_Id_no)}}" enctype="multipart/form-data">  {{csrf_field()}} 
                ...
                <div class="form-group">
                <label> Type: </label><input type="text" name="Type" class="form-control" placeholder="Type" value="{{$others->Type}}" /> 
                </div>
                <div class="form-group">
                <label> Style: </label><input type="text" name="Style" class="form-control" placeholder="Style" value="{{$others->Style}}" /> 
                </div>
