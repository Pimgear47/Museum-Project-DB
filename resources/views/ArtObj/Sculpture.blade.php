    ...
    <div class="row">
        ...
        <br>
            ...
            @if(auth()->check() && Auth::user()->status_admin == "1")
                <div align="right"><a href="{{action('SculptureController@create')}}" class="btn btn-primary">CREATE</a></div>
            @endif <br>
            ...
            <table class="table table-bordered table-striped"> 
                <tr> 
                    ...
                    @if(auth()->check() && Auth::user()->status_admin == "1")
                        <th><a href="{{action('SculptureController@edit',$row['art_obj_Id_no'])}}" class="btn btn-warning">Edit</a></th>
                        <th>
                            <form method="post" class="delete_form" action="{{action('SculptureController@destroy',$row['art_obj_Id_no'])}}">
                                {{csrf_field()}}
