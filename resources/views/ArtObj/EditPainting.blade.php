...
<div class="container">
    <div class="row">
        <div class="col-md-12">
        <br>
            <h3 align="center">Edit Painting</h3>
            ...
            @endif 
            <br>
            <form method="post" action="{{action('PaintingController@update', $art_obj_Id_no)}}" enctype="multipart/form-data">  {{csrf_field()}} 
                ...
                <div class="form-group">
                <label> Paint type: </label><input type="text" name="Paint_type" class="form-control" placeholder="Paint type" value="{{$paintings->Paint_type}}" /> 
                </div>
                <div class="form-group">
                <label> Drawn on: </label><input type="text" name="Drawn_on" class="form-control" placeholder="Drawn on" value="{{$paintings->Drawn_on}}" /> 
                </div>
                <div class="form-group">
                <label> Style: </label><input type="text" name="Style" class="form-control" placeholder="Style" value="{{$paintings->Style}}" /> 
                </div>
