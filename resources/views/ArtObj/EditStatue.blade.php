...
<div class="container">
    <div class="row">
        <div class="col-md-12">
        <br>
            <h3 align="center">Edit Statue</h3>
            ...
            @endif 
            <br>
            <form method="post" action="{{action('StatueController@update', $art_obj_Id_no)}}" enctype="multipart/form-data">  {{csrf_field()}} 
                ...
                <div class="form-group">
                <label> Height: </label><input type="text" name="Height" class="form-control" placeholder="Height" value="{{$statues->Height}}" /> 
                </div>
                <div class="form-group">
                <label> Weight: </label><input type="text" name="Weight" class="form-control" placeholder="Weight" value="{{$statues->Weight}}" /> 
                </div>
