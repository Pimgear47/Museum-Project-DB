...
<div class="container">
    <div class="row">
        <div class="col-md-12">
        <br>
            <h3 align="center">Create Painting</h3>
            ...
            @endif 
            <br>
            <form method="post" action="{{action('PaintingController@store')}}" enctype="multipart/form-data">  {{csrf_field()}} 
                ...
                <div id="ifpermanent" style="display: none;" class="form-control">
                        ...
                        <label for="coll_type_permanent">Status : </label> <select class="form-control" name="permanent_status">
