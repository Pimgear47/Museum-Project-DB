...
<div class="container">
    <div class="row">
        <div class="col-md-12">
        <br>
            <h3 align="center">Create Other</h3>
            ...
            @endif 
            <br>
            <form method="post" action="{{action('OtherController@store')}}" enctype="multipart/form-data">  {{csrf_field()}} 
                ...
                <div class="form-group">
                <label> Type: </label><input type="text" name="Type" class="form-control" placeholder="Type"/> 
                </div>
                <div class="form-group">
